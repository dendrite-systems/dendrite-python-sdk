...
from dendrite_sdk.sync_api._exceptions._constants import INVALID_AUTH_SESSION_MSG
...
class InvalidAuthSessionError(BaseDendriteException):
    ...
    def __init__(
        self, domain: Union[str, List[str]], message: str = INVALID_AUTH_SESSION_MSG
    ) -> None:
        self._domain = domain
...
class BrowserNotLaunchedError(BaseDendriteException):
    ...
    def __init__(
        self,
        message: str = "The browser should have been automatically launched by the Dendrite object.. Please reach out to us on GitHub or Discord if you are facing this issue.",
    ) -> None:
        super().__init__(message)
