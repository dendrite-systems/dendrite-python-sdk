...
from playwright.async_api import __all__
...
from dendrite_python_sdk._core._managers.active_page_manager import (
    PageManager,
)
...
from dendrite_python_sdk._core.models.authentication import (
    AuthSession,
)
from dendrite_python_sdk._core.models.llm_config import LLMConfig
from dendrite_python_sdk._api.browser_api_client import BrowserAPIClient
...
class DendriteBrowser:
    ...
    async def goto(
        ...
        """
        Navigates to the specified URL, optionally in a new page
